...
<form class="table solid-bordered" action="registered_events.php" method="post" align="center" style="color:black">
...
<!-- Modal Window that displays data from the event table based on the event ID with the special options to book which will redirect you to the bookings page -->
   ...
   <div class="modal-footer">
	<div style="text-align:center" class="col-md-12">
		<form action="bookings.php" method="post">
		 <button type="book" name="book" class="btn btn-warning">Book</button>
